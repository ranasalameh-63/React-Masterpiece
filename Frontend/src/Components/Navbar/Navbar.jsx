    ...
    <nav className={`bg-white transition-all duration-300 ${scrolled ? 'py-2' : 'py-3'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          {/* Mobile/Tablet Menu Button - Visible on smaller screens and tablets */}
          ...
          {/* Auth Section - Only visible on large screens */}
        ...
        {/* Mobile/Tablet Menu - For both small screens and tablets */}
        {menuOpen && (
          <div className="lg:hidden mt-3 pb-3 space-y-1">
            ...
            {/* Tablet-specific auth section */}
            <div className="pt-4 flex items-center justify-between px-3">
              {userId ? (
                <div className="relative w-full">
                  <button
                    onClick={() => setDropdownOpen(!dropdownOpen)}
                    className="flex items-center justify-between w-full text-[#FFA725] hover:text-black py-2 px-3 rounded-md"
                  >
                  ...
                  {dropdownOpen && (
                    <div className="mt-2 w-full bg-white border border-gray-200 rounded shadow-md z-10">
                      <Link
                        to={userRole === "expert" ? `/expertProfile/${userId}` : "/userProfile"}
                        className="block px-4 py-3 text-sm text-[#FFA725] hover:bg-gray-100 hover:text-black"
                        onClick={() => {
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-3 text-sm text-[#FFA725] hover:bg-gray-100 hover:text-black"
                      >
                        Logout
                      </button>
                    </div>
                ...
                <Link 
                  to="/login" 
                  className="block w-full py-2 px-3 text-base font-medium text-white bg-[#FFA725] rounded-md text-center"
                  onClick={() => setMenuOpen(false)}
                >
                  Login
                </Link>
