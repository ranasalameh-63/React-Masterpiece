...
//                                                 </button>
//                                             </>
//                                         ) : booking.status === 'confirmed' && !booking.voucherId && (
//                                             <button
//                                                 onClick={() => navigate(`/createVoucher/${booking._id}`)}
                                    ...
                                    <div className="mt-3 flex gap-2">
                                        {booking.status === 'pending' ? (
                                            <>
                                                <button
                                                    onClick={() => handleStatusChange(booking._id, 'confirmed')}
                                                    className="px-3 py-1 text-white text-sm rounded hover:bg-opacity-90 transition"
