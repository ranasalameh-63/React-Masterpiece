...
export default function Footer() {
  return (
    <div>
      <section className="py-10 bg-[#F8FAFC] sm:pt-16 lg:pt-24">
  ...
  <li>
    <a href="mailto:contact@diyrepair.com" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-[#A59D84]">
      {/* Email */}
      <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M3.75 4.5A2.25 2.25 0 0 0 1.5 6.75v10.5A2.25 2.25 0 0 0 3.75 19.5h16.5A2.25 2.25 0 0 0 22.5 17.25V6.75A2.25 2.25 0 0 0 20.25 4.5H3.75zm0 1.5h16.5c.414 0 .75.336.75.75v.44l-9 5.625-9-5.625V6.75c0-.414.336-.75.75-.75zm-.75 2.716V17.25c0 .414.336.75.75.75h16.5c.414 0 .75-.336.75-.75V8.716l-8.682 5.421a.75.75 0 0 1-.836 0L3 8.716z" />
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4">
                ...
                <li><Link to="/categories" className="text-base text-black transition-all duration-200">Categories</Link></li>
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4">
                ...
                <li><Link to="/" className="text-base text-black transition-all duration-200">DIY Guides</Link></li>
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
              <p className="text-sm font-bold tracking-widest text-[#FFA725] uppercase">Subscribe to our newsletter</p>
              <form action="#" method="POST" className="mt-6">
                <div>
                  <label htmlFor="email" className="sr-only">Email</label>
                  <input type="email" name="email" id="email" placeholder="Enter your email"
                    className="block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-[#FFA725]"
                  />
                </div>
                <button type="submit"
                  className="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-[#FFA725] rounded-md hover:bg-[#D68F17]">
                  Subscribe
                </button>
              </form>
            </div>
