...
//               <td>{payment.voucherId.voucherNumber}</td>
//               <td>{payment.voucherId.amount}</td>
//               <td>{payment.voucherId.details}</td>
//               <td>{new Date(payment.bookingId.preferredDate).toLocaleDateString()}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
